        ...
        >
            ...
            >
                <img 
                    ...
                    onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src='https://placehold.co/400x400/000000/ffffff?text=Error'; }}
                />
...
export default function About() {
    ...
    return (
        <div className="relative w-full min-h-screen bg-black flex flex-col items-center justify-center p-8 md:p-16 overflow-hidden">
            <div className="relative z-10 flex flex-col items-center text-center mb-16 pt-24">
                <motion.h1 
            ...
            {/* Gallery Grid */}
            <div className="relative z-10 w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pb-20">
